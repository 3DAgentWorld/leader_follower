...
# -*- coding: utf-8 -*-
"""
Avalon GRPO Training Reward Server.
...
class AvalonRewardMeasurer:
    ...
    def compute_log_probability(
        ...
        # Note: we encode the full sequence, then compute probability for the target part
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Avalon GRPO Training Reward Server"
    )
    parser.add_argument(
        "--model_path",
        type=str,
